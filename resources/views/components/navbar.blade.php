                ...
                <div class="relative ml-3">
                  <div>
                    <button @click="isOpen = !isOpen" type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                      ...
                      <img class="h-8 w-8 rounded-full" src="https://i.pinimg.com/736x/ef/aa/85/efaa85262c2979c0bce49d0dc643d49e.jpg" alt="">
                    </button>
                  </div>
        ...
        <div x-show="isOpen"class="md:hidden" id="mobile-menu">
          ...
          <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
              <div class="flex-shrink-0">
                <img class="h-10 w-10 rounded-full" src="https://i.pinimg.com/736x/ef/aa/85/efaa85262c2979c0bce49d0dc643d49e.jpg" alt="">
              </div>
              <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Ilham</div>
                <div class="text-sm font-medium leading-none text-gray-400">kucingilham@gmail.com</div>
              </div>
